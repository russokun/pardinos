        ...
        <div className="min-h-screen bg-base-950">
            ...
            <div className="max-w-6xl mx-auto px-6 py-8">
                <div className="text-center mb-10">
                    <h2 className="text-3xl font-black mb-3">Encuentra tu Ahijado Laboral</h2>
                    <p className="text-slate-400 max-w-2xl mx-auto">
                        Explora perfiles de jóvenes talentosos. Busca afinidad cultural y personal, no solo técnica. Tú das el primer paso.
                    </p>
                </div>
